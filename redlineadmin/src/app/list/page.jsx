...
const ProductList = () => {
  ...
  const visibleProducts = useMemo(() => {
    ...
    return products.filter((product) => {
      const matchesSearch = !needle || [product.name, product.slug, product.category]
        .filter(Boolean)
    ...
    <div className='space-y-6'>
      ...
      <section className='rounded border border-gray-200 bg-white p-4'>
        <div className='grid gap-3 md:grid-cols-[1fr_180px_180px]'>
          ...
          <select value={category} onChange={(event) => setCategory(event.target.value)} className='rounded border border-gray-300 px-3 py-2 outline-none focus:border-black'>
