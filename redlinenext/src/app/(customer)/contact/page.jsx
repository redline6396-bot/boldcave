...
const contactCards = [
  {
    icon: Mail,
    title: "Email",
    text: "support@greenvalleynaturals.com",
...
const quickPoints = [
  {
    ...
    text: "For bulk staples, grains, and flour supply.",
  },
  {
    title: "Product questions",
    text: "Ask about ingredients, sourcing, or packaging.",
  },
  {
    title: "Order support",
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_420px] lg:items-end">
            <div>
              ...
              <p className="mt-5 max-w-[560px] text-[14px] leading-7 text-[#5f5648] sm:text-[15px]">
                Have a question about our products, sourcing, wholesale supply,
                or your order? Send us a message and our team will get back to
                you.
              </p>
          ...
          <aside className="lg:sticky lg:top-6 lg:self-start">
            <div className="rounded-[18px] border border-[#e8dfd1] bg-[#fffdf8] p-6 sm:p-7">
              ...
              <h2 className="mt-3 font-display text-[34px] font-medium leading-[1.02] tracking-[-0.04em] text-[#332519] sm:text-[40px]">
                We’re here for your kitchen, your family, and your questions.
              </h2>
              ...
              <div className="mt-7 space-y-4 border-t border-[#eee6d9] pt-6">
                <InfoLine
                  icon={MapPin}
                  title="Serving"
                  text="Natural staples across India"
                />
                <InfoLine
                  icon={Clock}
                  title="Reply time"
                ...
                <InfoLine
                  icon={MessageCircle}
                  title="WhatsApp"
                  text="Fast contact for simple questions"
                />
              </div>
              ...
              >
                ...
                <div className="mt-7 space-y-6">
                  ...
                  <p className="text-center text-[11px] leading-5 text-[#7a756b]">
                    By submitting this form, you agree to our contact policy and
                    privacy terms.
                  </p>
                </div>
              </form>
