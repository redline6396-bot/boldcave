      ...
      <div className="mx-auto flex h-full w-full max-w-[720px] items-center justify-center gap-3 px-4 sm:gap-5">
        ...
        <div className="relative h-full min-w-0 flex-1 overflow-hidden">
          ...
          >
            ...
            <p
              key={`${message}-${index}`}
            className="flex h-full shrink-0 items-center justify-center overflow-hidden px-2 text-center text-[9px] font-medium uppercase tracking-[0.08em] text-neutral-950 sm:text-[11px] sm:tracking-[0.14em]"
              style={{ width: isTransitioning ? "50%" : "100%" }}
            >
              <span className="block max-w-full truncate">{message}</span>
            </p>
            ))}
          </div>
        </div>
