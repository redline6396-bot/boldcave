            ...
            {[
              ...
              return (
                <a
                  ...
                  className="inline-flex h-9 items-center border border-neutral-300 px-3 text-[11px] font-semibold uppercase tracking-[0.08em] text-neutral-950 transition-colors hover:border-neutral-950"
                >
                  {label}
                </a>
              );
