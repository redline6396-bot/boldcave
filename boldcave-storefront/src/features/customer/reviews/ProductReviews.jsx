...
export default function ProductReviews({ productId }) {
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-[620px] lg:max-w-[1180px]">
      ...
      {lightboxImage && (
        <div
          className="fixed inset-0 z-[200] flex cursor-zoom-out items-center justify-center bg-black/85 p-4 sm:p-6"
          role="dialog"
          aria-modal="true"
        ...
        >
          <button
            type="button"
            onClick={() => setLightboxImage("")}
            className="absolute right-4 top-4 z-[201] flex h-10 w-10 cursor-pointer items-center justify-center border border-white/30 bg-black/30 text-white transition-colors hover:bg-white hover:text-black sm:right-6 sm:top-6"
    ...
    >
      <div className="mx-auto max-w-[620px] text-center">
        ...
        <p className="mx-auto mt-8 max-w-[700px] text-[14px] leading-6 text-neutral-950">
          How we use your data: we use this information to manage your review
          and related communication. Your email address is not displayed
          publicly.{" "}
          <Link
            href="/privacy"
