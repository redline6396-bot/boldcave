...
const razorpayAttemptSchema = new mongoose.Schema(
  {
    ...
    razorpayPaymentCaptured: { type: Boolean },
    razorpayPaymentAmount: { type: Number, min: 0 },
    razorpayPaymentCurrency: { type: String, trim: true, uppercase: true },
    status: {
      type: String,
      enum: [
        "created",
